...
import 'detalles_tutoria_alu_model.dart';
export 'detalles_tutoria_alu_model.dart';

class DetallesTutoriaAluWidget extends StatefulWidget {
  const DetallesTutoriaAluWidget({
    Key? key,
  ...
  @override
  _DetallesTutoriaAluWidgetState createState() =>
      _DetallesTutoriaAluWidgetState();
}

class _DetallesTutoriaAluWidgetState extends State<DetallesTutoriaAluWidget> {
  late DetallesTutoriaAluModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetallesTutoriaAluModel());
  }
                      ...
                      child: Builder(
                        builder: (context) => FFButtonWidget(
                          onPressed: () async {
                            if (containerTutoriaRecord.estado == 'Activa') {
                              ...
                              await showAlignedDialog(
                                ...
                                builder: (dialogContext) {
                                  return Material(
                                    ...
                                    child: CalificarTutoriaAluWidget(
                                      tutoriaRef:
                              ...
                              await NotificacionRecord.collection.doc().set({
                                ...createNotificacionRecordData(
                                  user: containerTutoriaRecord.tutor,
                                  tutoria: containerTutoriaRecord.reference,
                                  mensaje:
                                      'El alumno ha finalizado la tutoría, aprieta aquí para calificar',
                                  alumno: containerTutoriaRecord.alumno,
                            ...
                            Navigator.pop(context);
                            if (containerTutoriaRecord.tutor ==
                                _model.chatRef?.userA) {
                          ...
                          if (containerTutoriaRecord.estado == 'Activa') {
                            _model.aluRef = await queryUsersRecordOnce(
                              queryBuilder: (usersRecord) => usersRecord.where(
                                'uid',
                                isEqualTo: containerTutoriaRecord.tutor?.id,
                              ),
                              singleRecord: true,
                            ).then((s) => s.firstOrNull);
